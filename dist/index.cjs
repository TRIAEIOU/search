...
class SearchPanel {
    constructor(view) {
        ...
        this.dom = elt__default["default"]("div", { onkeydown: (e) => this.keydown(e), class: "cm-search" }, [
            ...
            elt__default["default"]("label", null, [this.caseField, phrase(view, "Ab")]),
            elt__default["default"]("label", null, [this.reField, phrase(view, ".*")]),
            elt__default["default"]("label", null, [this.wordField, phrase(view, "⎵")]),
            ...view.state.readOnly ? [] : [
